...
* Add Dependencies: Web, DevTools, MySQL, JPA
...
```
* If you are using Java 9 or 10 (or if you're not sure), also add this.
...
# Database Connection
spring.datasource.url=jdbc:mysql://localhost:3306/db_demos?useSSL=false
